  ...
  const timeline = [
    {
      ...
      description: "Started with a vision to revolutionize HR consulting through technology and human expertise."
    },
    {
      year: "2023",
      title: "First 100 Placements",
      description: "Achieved our first major milestone by successfully placing 100 candidates across various industries."
    },
    {
      year: "2023",
      title: "AI Platform Launch",
      description: "Launched our proprietary AI-powered matching platform, increasing placement accuracy by 40%."
    },
    {
      year: "2024",
      title: "50+ Partner Companies",
      description: "Built a network of 50+ partner companies, establishing ourselves as a trusted HR solutions provider."
    }
  ];
            ...
            {processSteps.map((step, index) => (
              <Card 
                ...
                className={`glass hover-lift transition-all duration-500 ${
                  activeStep === index ? 'ring-2 ring-primary animate-pulse-glow' : ''
                } fade-in-up`}
