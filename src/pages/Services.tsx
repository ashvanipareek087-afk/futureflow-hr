...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      icon: Brain,
      title: "HR Consulting",
      description: "Strategic HR guidance to optimize your people operations",
      features: [
      ...
      details: {
        process: "Our consultants work closely with your team to understand your unique challenges and develop customized solutions.",
        benefits: [
          "Improve operational efficiency by 50%",
          "Reduce compliance risks by 80%",
          "Enhance employee satisfaction by 45%",
          "Streamline HR processes by 65%"
        ]
      }
    },
    {
      ...
      details: {
        process: "Our analytics platform aggregates data from multiple sources to provide actionable insights into your workforce dynamics.",
        benefits: [
          "Reduce turnover by 30%",
          "Optimize compensation by 20%",
          "Improve productivity by 35%",
          "Enhance decision-making speed by 70%"
        ]
      }
    }
  ];
        ...
        <div className="container mx-auto px-6">
          ...
          <Tabs defaultValue="talent-acquisition" className="max-w-6xl mx-auto">
            <TabsList className="grid w-full grid-cols-3 glass">
              <TabsTrigger value="talent-acquisition">Talent Acquisition</TabsTrigger>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricingPlans.map((plan, index) => (
              <Card 
                key={index} 
                className={`glass hover-lift relative fade-in-up ${
                  plan.popular ? 'ring-2 ring-primary animate-pulse-glow' : ''
                }`}
