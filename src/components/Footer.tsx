        ...
        <div className="py-16 grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold gradient-text">FutureFlow HR</span>
            </div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground">123 Business District, San Francisco, CA 94102</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground">hello@futureflowhr.com</span>
              </div>
            </div>
          </div>
        ...
        <div className="py-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-muted-foreground text-sm">
              © 2024 FutureFlow HR. All rights reserved.
            </div>
